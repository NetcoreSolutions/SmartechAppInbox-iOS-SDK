Pod::Spec.new do |s|
  ...
  s.ios.vendored_frameworks = 'Frameworks/SmartechAppInbox/SmartechAppInbox.framework'
  s.preserve_paths          = 'Frameworks/SmartechAppInbox/SmartechAppInbox.framework'
  s.module_map              = 'Frameworks/SmartechAppInbox/SmartechAppInbox.framework/Modules/module.modulemap'
